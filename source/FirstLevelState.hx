...
class FirstLevelState extends FlxState
{
	...
	override public function create()
	{
		...
		_background.loadMapFromCSV("assets/levels/Level1Background.csv", "assets/backgroundCafeteria.png", 32, 32);
		add(_background);

		_map = new FlxTilemap();
		_map.loadMapFromCSV("assets/levels/Level1.csv", "assets/tiles.png", 16, 16);
		add(_map);
